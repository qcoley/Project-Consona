...
def load_graphics():
    ...
    player_no_role_amuna_down_url = resource_path('resources/art/player_no_role_amuna_down_male.png')
    player_no_role_amuna_down_sheet = sprite_sheet((50, 75), player_no_role_amuna_down_url)
    loaded_dict["player_no_role_amuna_male_down_1"] = player_no_role_amuna_down_sheet[0]
    loaded_dict["player_no_role_amuna_male_down_2"] = player_no_role_amuna_down_sheet[1]
    loaded_dict["player_no_role_amuna_male_down_3"] = player_no_role_amuna_down_sheet[2]
    loaded_dict["player_no_role_amuna_male_down_4"] = player_no_role_amuna_down_sheet[3]
    player_no_role_amuna_up_url = resource_path('resources/art/player_no_role_amuna_up_male.png')
    player_no_role_amuna_up_sheet = sprite_sheet((50, 75), player_no_role_amuna_up_url)
    loaded_dict["player_no_role_amuna_male_up_1"] = player_no_role_amuna_up_sheet[0]
    loaded_dict["player_no_role_amuna_male_up_2"] = player_no_role_amuna_up_sheet[1]
    loaded_dict["player_no_role_amuna_male_up_3"] = player_no_role_amuna_up_sheet[2]
    loaded_dict["player_no_role_amuna_male_up_4"] = player_no_role_amuna_up_sheet[3]
    player_no_role_amuna_left_url = resource_path('resources/art/player_no_role_amuna_left_male.png')
    player_no_role_amuna_left_sheet = sprite_sheet((50, 75), player_no_role_amuna_left_url)
    loaded_dict["player_no_role_amuna_male_left_1"] = player_no_role_amuna_left_sheet[0]
    loaded_dict["player_no_role_amuna_male_left_2"] = player_no_role_amuna_left_sheet[1]
    loaded_dict["player_no_role_amuna_male_left_3"] = player_no_role_amuna_left_sheet[2]
    loaded_dict["player_no_role_amuna_male_left_4"] = player_no_role_amuna_left_sheet[3]
    player_no_role_amuna_right_url = resource_path('resources/art/player_no_role_amuna_right_male.png')
    player_no_role_amuna_right_sheet = sprite_sheet((50, 75), player_no_role_amuna_right_url)
    loaded_dict["player_no_role_amuna_male_right_1"] = player_no_role_amuna_right_sheet[0]
    loaded_dict["player_no_role_amuna_male_right_2"] = player_no_role_amuna_right_sheet[1]
    loaded_dict["player_no_role_amuna_male_right_3"] = player_no_role_amuna_right_sheet[2]
    loaded_dict["player_no_role_amuna_male_right_4"] = player_no_role_amuna_right_sheet[3]
    # player no role sorae race ----------------------------------------------------------------------------------------
    # alpha ------------------------------------------------------------------------------------------------------------
    player_no_role_sorae_down_url = resource_path('resources/art/player_no_role_sorae_down_a.png')
    player_no_role_sorae_down_sheet = sprite_sheet((50, 75), player_no_role_sorae_down_url)
    loaded_dict["player_no_role_sorae_a_down_1"] = player_no_role_sorae_down_sheet[0]
    loaded_dict["player_no_role_sorae_a_down_2"] = player_no_role_sorae_down_sheet[1]
    loaded_dict["player_no_role_sorae_a_down_3"] = player_no_role_sorae_down_sheet[2]
    loaded_dict["player_no_role_sorae_a_down_4"] = player_no_role_sorae_down_sheet[3]
    player_no_role_sorae_up_url = resource_path('resources/art/player_no_role_sorae_up_a.png')
    player_no_role_sorae_up_sheet = sprite_sheet((50, 75), player_no_role_sorae_up_url)
    loaded_dict["player_no_role_sorae_a_up_1"] = player_no_role_sorae_up_sheet[0]
    loaded_dict["player_no_role_sorae_a_up_2"] = player_no_role_sorae_up_sheet[1]
    loaded_dict["player_no_role_sorae_a_up_3"] = player_no_role_sorae_up_sheet[2]
    loaded_dict["player_no_role_sorae_a_up_4"] = player_no_role_sorae_up_sheet[3]
    player_no_role_sorae_left_url = resource_path('resources/art/player_no_role_sorae_left_a.png')
    player_no_role_sorae_left_sheet = sprite_sheet((50, 75), player_no_role_sorae_left_url)
    loaded_dict["player_no_role_sorae_a_left_1"] = player_no_role_sorae_left_sheet[0]
    loaded_dict["player_no_role_sorae_a_left_2"] = player_no_role_sorae_left_sheet[1]
    loaded_dict["player_no_role_sorae_a_left_3"] = player_no_role_sorae_left_sheet[2]
    loaded_dict["player_no_role_sorae_a_left_4"] = player_no_role_sorae_left_sheet[3]
    player_no_role_sorae_right_url = resource_path('resources/art/player_no_role_sorae_right_a.png')
    player_no_role_sorae_right_sheet = sprite_sheet((50, 75), player_no_role_sorae_right_url)
    loaded_dict["player_no_role_sorae_a_right_1"] = player_no_role_sorae_right_sheet[0]
    loaded_dict["player_no_role_sorae_a_right_2"] = player_no_role_sorae_right_sheet[1]
    loaded_dict["player_no_role_sorae_a_right_3"] = player_no_role_sorae_right_sheet[2]
    loaded_dict["player_no_role_sorae_a_right_4"] = player_no_role_sorae_right_sheet[3]
    # beta -------------------------------------------------------------------------------------------------------------
    player_no_role_sorae_down_url = resource_path('resources/art/player_no_role_sorae_down_b.png')
    player_no_role_sorae_down_sheet = sprite_sheet((50, 75), player_no_role_sorae_down_url)
    loaded_dict["player_no_role_sorae_b_down_1"] = player_no_role_sorae_down_sheet[0]
    loaded_dict["player_no_role_sorae_b_down_2"] = player_no_role_sorae_down_sheet[1]
    loaded_dict["player_no_role_sorae_b_down_3"] = player_no_role_sorae_down_sheet[2]
    loaded_dict["player_no_role_sorae_b_down_4"] = player_no_role_sorae_down_sheet[3]
    # player no role nuldar race ---------------------------------------------------------------------------------------
    player_no_role_nuldar_down_url = resource_path('resources/art/player_no_role_nuldar_down_male.png')
    player_no_role_nuldar_down_sheet = sprite_sheet((50, 75), player_no_role_nuldar_down_url)
    loaded_dict["player_no_role_nuldar_male_down_1"] = player_no_role_nuldar_down_sheet[0]
    loaded_dict["player_no_role_nuldar_male_down_2"] = player_no_role_nuldar_down_sheet[1]
    loaded_dict["player_no_role_nuldar_male_down_3"] = player_no_role_nuldar_down_sheet[2]
    loaded_dict["player_no_role_nuldar_male_down_4"] = player_no_role_nuldar_down_sheet[3]
    player_no_role_nuldar_up_url = resource_path('resources/art/player_no_role_nuldar_up_male.png')
    player_no_role_nuldar_up_sheet = sprite_sheet((50, 75), player_no_role_nuldar_up_url)
    loaded_dict["player_no_role_nuldar_male_up_1"] = player_no_role_nuldar_up_sheet[0]
    loaded_dict["player_no_role_nuldar_male_up_2"] = player_no_role_nuldar_up_sheet[1]
    loaded_dict["player_no_role_nuldar_male_up_3"] = player_no_role_nuldar_up_sheet[2]
    loaded_dict["player_no_role_nuldar_male_up_4"] = player_no_role_nuldar_up_sheet[3]
    player_no_role_nuldar_left_url = resource_path('resources/art/player_no_role_nuldar_left_male.png')
    player_no_role_nuldar_left_sheet = sprite_sheet((50, 75), player_no_role_nuldar_left_url)
    loaded_dict["player_no_role_nuldar_male_left_1"] = player_no_role_nuldar_left_sheet[0]
    loaded_dict["player_no_role_nuldar_male_left_2"] = player_no_role_nuldar_left_sheet[1]
    loaded_dict["player_no_role_nuldar_male_left_3"] = player_no_role_nuldar_left_sheet[2]
    loaded_dict["player_no_role_nuldar_male_left_4"] = player_no_role_nuldar_left_sheet[3]
    player_no_role_nuldar_right_url = resource_path('resources/art/player_no_role_nuldar_right_male.png')
    player_no_role_nuldar_right_sheet = sprite_sheet((50, 75), player_no_role_nuldar_right_url)
    loaded_dict["player_no_role_nuldar_male_right_1"] = player_no_role_nuldar_right_sheet[0]
    loaded_dict["player_no_role_nuldar_male_right_2"] = player_no_role_nuldar_right_sheet[1]
    loaded_dict["player_no_role_nuldar_male_right_3"] = player_no_role_nuldar_right_sheet[2]
    loaded_dict["player_no_role_nuldar_male_right_4"] = player_no_role_nuldar_right_sheet[3]
