...
def player_updates():
    gameplay_functions.player_info_and_ui_updates(player, screen, hp_bar, en_bar, xp_bar, in_over_world,
                                                  ...
                                                  basic_staff_img, basic_sword_img, basic_bow_img, basic_robes_img,
                                                  basic_armor_img, basic_tunic_img, temp_img,
