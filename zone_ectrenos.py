...
def ectrenos_main(pygame, screen, graphic_dict, player, ectrenos_bg, eldream_building_music, over_world_song_set,
                  ...
                  UiElement, seldon_flowers, interactables_eldream, ectrenos_entrance):
    ...
    ectrenos_return = {"over_world_song_set": over_world_song_set, "npc_tic": npc_tic, "info_text_1": info_text_1,
